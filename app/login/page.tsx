      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-restaurant-primary text-white rounded-lg font-semibold hover:bg-restaurant-primary-dark transition-all duration-150 shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
